...
//AI
routerApp.get   ("/aubud/api/v1/budget/get-data-for-auto-budget", budgetController.getAutoGeneratedBudget)
routerApp.post   ("/aubud/api/v1/budget/auto-generate",authenticateJWT, budgetController.generateBudget)
routerApp.post   ("/aubud/api/v1/budget/add-mutiple",authenticateJWT, budgetController.addMultipleBudget)
