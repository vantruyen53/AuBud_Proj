...
import styles from "../../../assets/styles/addTransactionStyle";
import {
  mockCategoriesIncome,
  mockCategoriesSending,
} from "../../../store/seed/category";
...
import TypeDebt from "../../../components/typeDebts";
...
export default function AddTransactionScreen() {
  ...
  // Các trạng thái quản lý việc mở modal chọn ví, nợ, lịch, tiết kiệm, v.v.
  ...
  // Ví đích (dùng cho giao dịch chuyển tiền giữa các ví)
  ...
  // Tên chi tiết của danh mục (ghi chú nhanh)
  const [detailCat, setDetailCat] = useState("");
  
  // Xác định modal đang được mở cho ví nguồn hay ví đích
  ...
  // Hàm định dạng số tiền (thêm dấu chấm phân cách hàng nghìn)
