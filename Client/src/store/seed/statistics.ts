import { IStatisticDate, IStatisticCategory } from "@/src/models/IApp";
...
const yearlyStatistics: IStatisticDate[] = [
  ...
  { id: 'm2', date: 'Feb', income: 45000000, sending: 35000000 }, // Tết: chi nhiều, thu nhiều
  ...
  { id: 'm12', date: 'Dec', income: 40000000, sending: 38000000 }, // Cuối năm mua sắm nhiều
];
